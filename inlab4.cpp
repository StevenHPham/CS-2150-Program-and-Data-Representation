...
int main(){
	...
	string nonPointers[6][5] = {
		...
		{"float", "4" /*size*/, "3.402e+38" /*max value*/, "0x00000000" /*zero as stored in hex*/, "0x3f800000" /*one as stored in hex*/},
		{"double", "8" /*size*/, "1.79769e+308" /*max value*/, "0x00000000" /*zero as stored in hex*/, "0x3ff00000" /*one as stored in hex*/},
		{"char", "1" /*size*/, "127" /*max value*/, "0x00000030" /*zero as stored in hex*/, "0x00000131" /*one as stored in hex*/},
		{"bool", "1" /*size*/, "1" /*max value*/, "0x00000000" /*zero as stored in hex*/, "0x00000001" /*one as stored in hex*/},

	};

	string pointers[3][4] = {
		{"int*", "8" /*size*/, "0x7FFFFFFF" /*max value*/, "0x00000000" /*NULL as stored in hex*/},
		{"char*", "8" /*size*/, "0x7FFFFFFF" /*max value*/, "0x00000000" /*NULL as stored in hex*/},
		{"double*", "8" /*size*/, "0x7FFFFFFF" /*max value*/, "0x00000000" /*NULL as stored in hex*/},
	};
